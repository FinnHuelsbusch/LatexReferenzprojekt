...
\usepackage{longtable,siunitx, array}
...
\input{content/00_LaTeX/apperance/highlightBoxes}  % Weitere Details sind ausgelagert
...
\input{content/00_LaTeX/apperance/sourceCodeStyle}  % Weitere Details sind ausgelagert
