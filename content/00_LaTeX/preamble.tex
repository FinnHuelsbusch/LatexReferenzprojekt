...
%------------------------------------ Informationen ------------------------------------%
% Bei diesem Dokument handelt es sich um die Präambel des Dokuments. Hier sollten keine weiteren Änderungen vorgenommen werden, da das Dokument sonst nicht übersetzt wird. 
...
\usepackage[ngerman]{babel}					% Sprache wird auf Deutsch festgelegt
...
\usepackage{lmodern}									% Pakte um die Schriftart zu Latin Modern zu ändern
...
\usepackage{amsmath}    					% Erweiterung vom Mathe-Satz durch Funktionen
...
\usepackage[
	...
	%bibencoding = auto,			% Ist die Standardeinstellung und kann weggelassen werden
...
\acsetup{ list/display = used, list/sort = true, list/template = table}
