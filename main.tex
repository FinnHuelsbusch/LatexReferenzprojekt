...
\input{content/00_LaTeX/grammar}
...
\input{content/00_LaTeX/runVariables}
...
\begin{document}
	...
	\pagestyle{plain}
	\include{content/05_lists/formular}
	\include{content/05_lists/acronym}
	...
	{}
	{
   	\include{content/08_instructions/01_einleitung}
   	\include{content/08_instructions/02_abbildungen}
   	\include{content/08_instructions/03_formatText}
   	\include{content/08_instructions/04_mathematische-formeln}
   	\include{content/08_instructions/05_quellcode}
	\include{content/08_instructions/06_literaturHinweis}
	}
